...
**2001 — [JSON](http://json.org/), основанные на JavaScript формат обмена данными.** В 2001 Дуглас Крокфорд \(Douglas Crockford\) дал название и документировал JSON \(JavaScript Object Notation\) - способ в стиле языка Lisp, позволяющий использовать синтаксис JavaScript позволяющий сохранять данные в текстовом формате. JSON использует литералы объектов, массивов, строк чисел и булевых значение JavaScript для представления структур данных. Пример:
...
Спустя годы JSON стал популярной легковесной альтернативой XML, особенно когда структура представляет данные без разметки. И действительно, в JavaScript очень удобно работать JSON.
